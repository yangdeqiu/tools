...
public class ObjectSizeFetcher {
    ...
    public static void main(String[] args){
        ...
        double d = 1.1D;
        Object o = new Object();
//        System.out.println(ObjectSizeFetcher.sizeOf(a));
        System.out.println(RamUsageEstimator.sizeOf(a));
        System.out.println(RamUsageEstimator.shallowSizeOf(a));
        System.out.println(RamUsageEstimator.sizeOf(a1));
        System.out.println(RamUsageEstimator.sizeOf(a2));
        System.out.println(RamUsageEstimator.sizeOf(n));
